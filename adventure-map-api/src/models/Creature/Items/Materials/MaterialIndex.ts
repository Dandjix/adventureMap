...
export class MaterialIndex
{
    ...
    public static createDefaultMaterialIndex()
    {
        ...
        index.Add(new Liquid("water",1,0,10))
        index.Add(new Metal("steel",8,1,300))
        index.Add(new Metal("lead",11.3,0.5,100))
        index.Add(new Metal("gold",19.3,0.5,1000))
        index.Add(new Leather("cow leather",1,0.1,50))
        return index
    }
}